...
const CHECKOUT_NEXT_PAGE_SLUG = "5/order/en/uk/upsell1b";

function getNextPageSlugForRedirect() {
  const normalize = (value) => {
    if (!value) return "";
    return value.startsWith("/69fd4b6d9099275155855fd9-preview") ? value : (value.startsWith("/") ? "/69fd4b6d9099275155855fd9-preview" + value : "/69fd4b6d9099275155855fd9-preview/" + value);
  };
...
const getVrioCampaignInfoBasedOnPaymentMethod = (isVipUpsell) => {
    const vrioCampaigns = [{"_id":"69fc23a59099275155853f1c","integration":[{"_id":"68de8b4ba7998abc5f77b02a","workspace":"develop","platform":"vrio","description":"production","fields":{"publicApiKey":"eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzY29wZSI6ImFkbWluIiwib3JnYW5pemF0aW9uIjoibXZtdC52cmlvIiwiaWQiOiJhZTE4OGY0ZC0yMDAwLTQ4ZWItOGE4YS03OGY1ZjBiMWQxZGMiLCJpYXQiOjE3NTU3MjQ1OTIsImF1ZCI6InVybjp2cmlvOmFwaTp1c2VyIiwiaXNzIjoidXJuOnZyaW86YXBpOmF1dGhlbnRpY2F0b3IiLCJzdWIiOiJ1cm46dnJpbzphcGk6MjIifQ.51xFtExTqVm3o2mhizx3VsiSTv7pNAB6beF1rmV_-Jg","internalApiKey":"eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzY29wZSI6ImFkbWluIiwib3JnYW5pemF0aW9uIjoibXZtdC52cmlvIiwiaWQiOiJhZTE4OGY0ZC0yMDAwLTQ4ZWItOGE4YS03OGY1ZjBiMWQxZGMiLCJpYXQiOjE3NTU3MjQ1OTIsImF1ZCI6InVybjp2cmlvOmFwaTp1c2VyIiwiaXNzIjoidXJuOnZyaW86YXBpOmF1dGhlbnRpY2F0b3IiLCJzdWIiOiJ1cm46dnJpbzphcGk6MjIifQ.51xFtExTqVm3o2mhizx3VsiSTv7pNAB6beF1rmV_-Jg"},"status":"active","createdAt":1758437407128,"updatedAt":1759415115447,"__v":0,"category":"CRM","id":"68de8b4ba7998abc5f77b02a"}],"externalId":"314","name":"Akemi Detox Tea - Network - (1) - United Kingdom","currency":"GBP","countries":[222],"metadata":{"campaign_id":314,"campaign_name":"","payment_type_id":1,"campaign_active":true,"campaign_prepaid":true,"campaign_payment_method_required":true,"campaign_group_transactions":true,"campaign_global_js":"","campaign_global_seo_title":"","campaign_global_seo_keywords":"","campaign_global_seo_description":"","date_created":"2026-05-07 05:31:18","created_by":0,"date_modified":"2026-05-07 05:31:18","modified_by":0,"campaign_notes":"","offers":[],"shipping_profiles":[],"campaignId":"314","externalId":314,"description":"","payment_methods":["amex","discover","visa","master"],"alternative_payments":[],"countries":[{"iso_numeric":826,"calling_code":"44","id":222,"name":"United Kingdom of Great Britain and Northern Ireland (the)","iso_2":"GB","iso_3":"GBR"}]},"funnels":[],"createdAt":1778090535327,"updatedAt":1778131878099,"packages":[],"status":"active","platform":"vrio","__v":0,"id":"69fc23a59099275155853f1c"}];
...
const DEFAULT_OFFER_ID = '328';
const getVrioOfferInfoByProductId = (productId) =>
  ((productId) => {
    const vrioOffers = [{"id":328,"offerTypeId":2,"name":"Akemi Detox Tea - VIP - United Kingdom","items":[{"name":"VIP Customer Benefits","id":26,"quantity":1,"price":0,"shippable":false}]},{"id":327,"offerTypeId":1,"name":"Akemi Detox Tea - Network - United Kingdom","items":[{"name":"1x Pack of Detox Tea (28 Bags)","id":1749,"quantity":1,"price":0,"shippable":false},{"name":"2x Pack of Detox Tea (56 Bags)","id":1746,"quantity":1,"price":0,"shippable":false},{"name":"3x Pack of Detox Tea (84 Bags)","id":1747,"quantity":1,"price":0,"shippable":false},{"name":"Akemi Detox Tea","id":1698,"quantity":1,"price":0,"shippable":true},{"name":"Akemi Detox Tea  Journey Package Protection","id":1703,"quantity":1,"price":0,"shippable":false},{"name":"Akemi Detox Tea - 3 Year Warranty","id":1702,"quantity":1,"price":0,"shippable":false},{"name":"Special 1x EXTRA Akemi Detox Tea","id":1704,"quantity":1,"price":0,"shippable":false},{"name":"Special 1x EXTRA Akemi Detox Tea","id":1719,"quantity":1,"price":0,"shippable":false}]}];
...
const getPrices = () => {
  return [{"name":"VIP Customer Benefits","id":26,"quantity":1,"price":0,"shippable":false,"fullPrice":0,"finalPrice":0,"productName":"VIP Customer Benefits","discountAmount":0,"discountPercentage":0},{"name":"1x Pack of Detox Tea (28 Bags)","id":1749,"quantity":1,"price":0,"shippable":false,"fullPrice":35.03,"finalPrice":35.03,"productName":"1x Pack of Detox Tea (28 Bags)","discountAmount":0,"discountPercentage":0},{"name":"2x Pack of Detox Tea (56 Bags)","id":1746,"quantity":1,"price":0,"shippable":false,"fullPrice":57.85,"finalPrice":57.85,"productName":"2x Pack of Detox Tea (56 Bags)","discountAmount":0,"discountPercentage":0},{"name":"3x Pack of Detox Tea (84 Bags)","id":1747,"quantity":1,"price":0,"shippable":false,"fullPrice":75.53,"finalPrice":75.53,"productName":"3x Pack of Detox Tea (84 Bags)","discountAmount":0,"discountPercentage":0},{"name":"Akemi Detox Tea  Journey Package Protection","id":1703,"quantity":1,"price":0,"shippable":false,"fullPrice":0,"finalPrice":0,"productName":"Akemi Detox Tea  Journey Package Protection","discountAmount":0,"discountPercentage":0},{"name":"Akemi Detox Tea - 3 Year Warranty","id":1702,"quantity":1,"price":0,"shippable":false,"fullPrice":0,"finalPrice":0,"productName":"Akemi Detox Tea - 3 Year Warranty","discountAmount":0,"discountPercentage":0},{"name":"Special 1x EXTRA Akemi Detox Tea","id":1704,"quantity":1,"price":0,"shippable":false,"fullPrice":0,"finalPrice":0,"productName":"Special 1x EXTRA Akemi Detox Tea","discountAmount":0,"discountPercentage":0},{"name":"Special 1x EXTRA Akemi Detox Tea","id":1719,"quantity":1,"price":0,"shippable":false,"fullPrice":0,"finalPrice":0,"productName":"Special 1x EXTRA Akemi Detox Tea","discountAmount":0,"discountPercentage":0}]
};
...
async function createOrderViaWallet(confirmationToken, paymentMethodId) {
  ...
  const orderData = {
    pageId: "9mFpKV9amXC10uyzeoYM98Rt1QN0vKW_AXOl9sTLiL7tepG9ccCUcMhKqwZtkXpU",
    action: "process",
...
const getStates = async (countryIso2Code) => {
  ...
  try {
    if (!countriesStatesCache) {
      const res = await fetch('/69fd4b6d9099275155855fd9-preview/scripts/countriesData/countriesStates.json', { cache: 'no-store' });
...
if (typeof validateAndSendToKlaviyo === "function") {
  try {
    ...
    var pageReadyPayload = {
      ...
      data: { pageName: "ADT-UK-Checkout-V1", pageType: "Checkout" },
    };
